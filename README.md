...
The project automates the deployment of a sample web application hosted on an **Nginx** server. The application is containerized using **Docker** and deployed on an **Amazon Linux Machine(AWS)**. The infrastructure is provisioned using **Terraform**, and the CI/CD pipeline is implemented using **GitHub Actions**.

---

## **Features**

- **Infrastructure as Code (IaC)**: Terraform scripts automate the provisioning of AWS resources (VM, network, security groups).
